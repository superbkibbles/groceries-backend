...
type User struct {
	...
	CartID       primitive.ObjectID `json:"cart_id,omitempty" bson:"cart_id,omitempty"` // Cart ID for the user
...
// NewAddress creates a new address for a user (ID will be auto-generated by MongoDB)
func NewAddress(userID primitive.ObjectID, name, addressLine1, addressLine2, city, state, country, postalCode, phone string, isDefault bool) *Address {
	now := time.Now()
	return &Address{
		UserID:       userID,
		Name:         name,
